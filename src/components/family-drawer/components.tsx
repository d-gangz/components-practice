...
export function Phrase({ setView }: { setView: (view: string) => void }) {
  return (
    <div>
      <div className="px-2">
        <Header
...
export function Key({ setView }: { setView: (view: string) => void }) {
  return (
    <div>
      <div className="px-2">
        <Header
...
export function RemoveWallet({ setView }: { setView: (view: string) => void }) {
  return (
    <div>
      <div className="px-2">
        <Header
...
export function DefaultView({ setView }: { setView: (view: string) => void }) {
  return (
    <>
